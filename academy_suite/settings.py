"""
Django settings for EduFlow-AcademySuite project.

This is the central configuration file. It loads environment variables for
security and flexibility and wires up all the applications and components.
"""
import os
